...
router.post("/:id/exercises", auth_1.authenticateUser, async (req, res) => {
    const userId = req.userId;
    const supabase = req.supabase;
    const workoutId = req.params.id;
...
router.post("/:workoutId/exercises/:workoutExerciseId/sets", auth_1.authenticateUser, async (req, res) => {
    const userId = req.userId;
    const supabase = req.supabase;
...
router.patch("/:workoutId/exercises/:workoutExerciseId/sets/:setId", auth_1.authenticateUser, async (req, res) => {
    const supabase = req.supabase;
...
router.delete("/:workoutId/exercises/:workoutExerciseId/sets/:setId", auth_1.authenticateUser, async (req, res) => {
    const supabase = req.supabase;
